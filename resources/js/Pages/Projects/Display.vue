                ...
                <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                  <div>
                    <h1
                      ...
                      {{ project.title }} <span class="text-main">Project</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">{{ project.description }}</p>
                  </div>
                  <!-- End Col -->

                  <div class="relative ms-4 shadow-sm">
                    <img class="w-full h-96 object-cover rounded-md" :src="project.image" :alt="project.title">
                    <div
