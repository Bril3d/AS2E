  ...
  <div>
    ...
    <NavBar>
      ...
      <template #default>
        <div class="py-20">
          <!-- Hero -->
          <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 dark:bg-neutral-900 rounded-md">
            <!-- Grid -->
                ...
                <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                  ...
                  <div class="py-5">
                    <div class="flex space-x-1">
                      <svg class="size-4 text-gray-800 dark:text-neutral-200" width="51" height="51" viewBox="0 0 51 51"
