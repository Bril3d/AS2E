...
const updateexpertise = () => {
  form.post(route("expertises.update", props.expertise.slug), {
    preserveState: true,
  });
};
</script>
...
<template>
  ...
  <Head title="Edit Expertise" />

  <AuthenticatedLayout>
    <template #header>
      <div class="text-xl font-bold leading-tight text-gray-800 cursor-default dark:text-gray-200">
        <Link :href="route('dashboard.expertises.index')">expertises / </Link>
        <span class="text-indigo-500">{{ props.expertise.title }}</span>
        <span> / Edit</span>
      </div>
    </template>
      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
          <div class="p-6 bg-white border-b dark:border-b-0 dark:bg-gray-800">
            <form @submit.prevent="updateexpertise">
              <div class="grid grid-cols-2 gap-3 mb-3">
                ...
                <div class="w-full col-span-2 mb-3 md:col-span-1">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <button v-if="urlImage || expertise.image" @click="imageField().onRemove" type="button"
                  ...
                  <img v-if="urlImage || expertise.image" :src="urlImage || expertise.image
