    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            <div>
                ...
                <TextInput id="email" type="email" class="mt-1 block w-full dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" v-model="form.email" required autofocus
            ...
            <div class="mt-4">
                ...
                <TextInput id="password" type="password" class="mt-1 block w-full dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" v-model="form.password" required
            ...
            <div class="block mt-4">
                <label class="flex items-center">
                    <Checkbox name="remember" v-model:checked="form.remember" class="dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" />
