<template>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <SectionHeader title="Our Services" caption="Empowering Your Operations with Cutting-edge Solutions" />
    <!-- Grid -->
    <div class="grid md:grid-cols-2 gap-12">
      <div class="lg:w-3/4">
        <h2 class="text-3xl text-gray-800 font-bold lg:text-4xl dark:text-white">
          Streamlined Automation for Enhanced Operational Efficiency
        </h2>
      ...
      <div class="space-y-6 lg:space-y-10">
        ...
        <div class="flex">
          ...
          <div class="ms-5 sm:ms-8">
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
              Our advanced automation tools streamline your processes, improving accuracy and efficiency across various operational tasks.
            </p>
          </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div class="flex">
          ...
          <div class="ms-5 sm:ms-8">
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
              We design and implement energy-efficient solutions, leveraging automation to minimize energy consumption and environmental impact.
            </p>
          </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div class="flex">
          ...
          <div class="ms-5 sm:ms-8">
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
              Our comprehensive documentation and client libraries simplify the integration process, enabling custom solutions tailored to your unique needs.
            </p>
          </div>
        </div>
        <!-- End Icon Block -->
